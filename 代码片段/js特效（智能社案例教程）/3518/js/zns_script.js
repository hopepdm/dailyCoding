...
window.onload=function ()
{
	...
	document.getElementById('btn_turn').onclick=function ()
	{
		...
		/*zns.site.fx.addEnd(oDivPage, function (){
			
			
			//setStyle3(oImg, 'transform', 'scaleY(-1)');
			
			
			setTimeout(function (){
				setStyle3(oDivPage, 'transition', 'none');
				setStyle3(oDivPage, 'transition', '0.5s all ease-out');
				
				oDivShadow.style.background='rgba(0,0,0,0)';
			}, 0);
